...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("want_to_read", "reading", "read", "abandoned", name="bookstatus", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("pending", "accepted", "blocked", name="friendshipstatus", create_type=False), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("source", postgresql.ENUM("dna_similarity", "mood", "collaborative", "ai_prompt", "friend", name="recommendationsource", create_type=False), nullable=False),

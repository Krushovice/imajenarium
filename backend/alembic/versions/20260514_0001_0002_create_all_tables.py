...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("emotional_tags", postgresql.JSONB(), server_default="'[]'", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("quotes", postgresql.JSONB(), server_default="'[]'", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("emotion_tags", postgresql.JSONB(), server_default="'[]'", nullable=False),
        sa.Column("quotes", postgresql.JSONB(), server_default="'[]'", nullable=False),
